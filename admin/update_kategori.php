    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    ?>
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" disabled name="tgl_buat" value="<?php echo $tampil['tgl_buat'] ?>" autocomplete="off">
                            </div>
            ...
            if (isset($_POST['btnupdate'])) {
                ...
                $query = "UPDATE kategori SET nama_kategori='$nama_kategori',tgl_buat='$tgl_buat' where id_kategori='$id_kategori'";
