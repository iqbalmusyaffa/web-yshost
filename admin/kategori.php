...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#modalTambah"><i class=" fas fa-plus fa-sm text-white-50"></i> Tambah Kategori</a>
                    </div>
                    <table id="data" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $kategori = mysqli_query($konek, "SELECT * FROM kategori ORDER BY id_kategori DESC");
    ...
    <div class="modal fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="modalTambah" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-edit"></i> Input Nama Kategori</h5>
                ...
                <form action="" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <input type="submit" class="btn btn-primary btn-submit" id="btnsimpan" name="btnsimpan"></input>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="" method="POST">
                    <div class="form-group">
                        <label>Nama Kategori</label>
                        <input type="text" class="form-control" id="nama_kategori_ubah" name="nama_barang" autocomplete="off">
                    </div>
                    <div class="modal-footer">
